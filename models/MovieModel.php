...
class MovieModel extends BaseModel
{
     ...
     public function addMovie($title, $description, $duration, $director, $release_movie, $trailer_path, $poster_path, $view)
     {
          $data = [
               'title' => $title,
     ...
     public function updateMovie($id, $title, $description, $duration, $director, $release_movie, $trailer_path, $poster_path, $view)
     {
